...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NotesViewHolder>{
    ...
    public NotesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = li.inflate(me.rishabhkhanna.multicopy.R.layout.notes_layout,parent,false);
    ...
    public void onBindViewHolder(final NotesViewHolder holder, final int position) {
        ...
        holder.itemView.setBackgroundColor(mSelectedItems.get(position)? context.getResources().getColor(me.rishabhkhanna.multicopy.R.color.ColorPrimaryLight): Color.TRANSPARENT);
    }
    ...
    public class NotesViewHolder extends RecyclerView.ViewHolder{
        ...
        public NotesViewHolder(View itemView) {
            super(itemView);
            tvNote = (TextView) itemView.findViewById(me.rishabhkhanna.multicopy.R.id.tvNoteText);
            tvTimeStamp = (TextView) itemView.findViewById(me.rishabhkhanna.multicopy.R.id.tvCreatedAt);
            noteCardView = (CardView) itemView.findViewById(me.rishabhkhanna.multicopy.R.id.notesCardView);
            selectedOverlay = itemView.findViewById(me.rishabhkhanna.multicopy.R.id.selected_overlay);
